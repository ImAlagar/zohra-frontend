          ...
          <AnimatePresence>
            {(errorMessage || localError) && (
              <motion.div 
                ...
                className="bg-red-500/20 border border-red-500 text-red-500 px-4 py-3 rounded-lg mb-6 text-sm overflow-hidden text-center font-inter"
              >
                {errorMessage || localError}
              </motion.div>
            )}
          ...
          <AnimatePresence>
            {success && (
              <motion.div 
                ...
                exit={{ opacity: 0, height: 0 }}
                transition={{ duration: 0.3 }}
                className="bg-green-500/20 border border-green-500 text-green-500 px-4 py-3 rounded-lg mb-6 text-sm overflow-hidden text-center font-inter"
              >
                {success}
              </motion.div>
            )}
